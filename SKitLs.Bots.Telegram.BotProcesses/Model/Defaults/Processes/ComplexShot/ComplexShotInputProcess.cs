...
namespace SKitLs.Bots.Telegram.BotProcesses.Model.Defaults.Processes.ComplexShot
{
    ...
    public class ComplexShotInputProcess<TResult> : TextInputsProcessBase<TResult> where TResult : notnull
    {
        /// <summary>
        ...
        public ComplexShotInputProcess(IST processData, DynamicArg<TResult, IOutputMessage> startupMessage, ProcessCompletedByCallback<TResult> overByCallback, DynamicArg<TResult, IOutputMessage>? confirmMessage = null)
        ...
        /// <param name="startupMessage">The startup message of the bot process.</param>
        /// <param name="overByCallback">The action that is invoked when the running bot process is completed.</param>
        public ComplexShotInputProcess(string processDefId, string terminationalKey, IUserState processState, DynamicArg<TResult, IOutputMessage> startupMessage, ProcessCompletedByCallback<TResult> overByCallback, DynamicArg<TResult, IOutputMessage>? confirmMessage = null)
        ...
        public ComplexShotInputProcess(IST processData, DynamicArg<TResult, IOutputMessage> startupMessage, ProcessCompletedByInput<TResult> overByInput)
        ...
        /// <param name="startupMessage">The startup message of the bot process.</param>
        /// <param name="overByInput">The action that is invoked when the running bot process is completed.</param>
        public ComplexShotInputProcess(string processDefId, string terminationalKey, IUserState processState, DynamicArg<TResult, IOutputMessage> startupMessage, ProcessCompletedByInput<TResult> overByInput)
